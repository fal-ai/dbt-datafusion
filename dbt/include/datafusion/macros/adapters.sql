...
{% macro datafusion__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro datafusion__check_schema_exists(information_schema,schema) -%}
...
{% macro datafusion__create_schema(relation) -%}
...
{% macro datafusion__drop_relation(relation) -%}
...
{% macro datafusion__drop_schema(relation) -%}
...
{% macro datafusion__get_columns_in_relation(relation) -%}
...
{% macro datafusion__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro datafusion__list_schemas(database) -%}
...
{% macro datafusion__rename_relation(from_relation, to_relation) -%}
...
{% macro datafusion__truncate_relation(relation) -%}
...
{% macro datafusion__current_timestamp() -%}
